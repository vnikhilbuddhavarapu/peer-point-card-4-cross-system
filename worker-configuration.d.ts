/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0ce3769718d54f9c1d9d4b2bf9029d0)
// Runtime types generated with workerd@1.20260911.1 2026-09-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	AI_GATEWAY_ID: "default";
	MCP_PORTAL_URL: "https://ppug-demo-mcp.cf.prompt2prod.dev/mcp";
	MCP_DIRECT_BASE_URL: "https://peer-point-synthetic-mcp.peer-point-user-group.workers.dev";
	CITY: "Montreal";
	CARD: "cross-system";
	ENVIRONMENT: "starter";
	CROSS_SYSTEM_AGENT: DurableObjectNamespace<import("./src/server").CrossSystemAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CrossSystemAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "MCP_PORTAL_URL" | "MCP_DIRECT_BASE_URL" | "CITY" | "CARD" | "ENVIRONMENT">> {}
}
